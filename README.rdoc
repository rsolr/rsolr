...
You can access the original request (path, params, query etc.) and response by providing a block to ANY of the request methods:
...
==NOOP
You can get the request context sent to Solr without actually sending it... if you set :noop => true to any of the request methods:
