...
==Indexing
Solr (ruby) comes with a simple indexer that makes use of the Mapper::Base class. Here's an example using the mapping and mapped_data above of the RSS mapper above (mapped_data):
