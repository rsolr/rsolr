...
In general, the direct connection is less than ideal in most applications. You'll be missing out on Http caching, and it'll be impossible to do distributed searching. Where the direct connection could possibly come in handy though, is indexing lots of documents quickly.
