...
nil is passed in as the query string data. The :data ends up serialized as a form-encoded query string, and the correct content-type headers are sent along to Solr.
