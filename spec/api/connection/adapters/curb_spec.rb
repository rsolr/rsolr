unless jruby?
  ...
  describe RSolr::Connection::Adapters::Curb do
      ...
      #     http = new_curb
      #     http.send(:connection).should be_a ::Curl::Easy
      #   end
      #   
      # end
      # 
      ...
      #     c.should_receive(:url=).with 'http://127.0.0.1:8983/solr/select?q=1'
      #     c.should_receive(:multipart_form_post=).with false
      #     c.should_receive(:perform)
      #     
